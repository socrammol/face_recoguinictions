...
output_video = cv2.VideoWriter('output.avi', fourcc, 23.0, size)

# Load some sample pictures and learn how to recognize them.
female_image = face_recognition.load_image_file("arquivos/elli.jpeg")
female_face_encoding = face_recognition.face_encodings(female_image)[0]

male_image = face_recognition.load_image_file("arquivos/allan_grant.jpeg")
